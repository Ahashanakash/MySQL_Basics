...
-- showing table or column by select keyword
SELECT *
FROM EMPLOYEES;

-- showing specific row or details by WHERE keyword (condition)
SELECT *
FROM employees
WHERE salary>=13000 AND salary<=17000;

-- arithmatic operation
SELECT salary, salary+10000
FROM employees;
...
-- showing specific number of rows (1-5, 4-10, 55-65)
SELECT *
FROM employees
LIMIT 5;  -- Showing First 5 rows
...
SELECT *
FROM employees
WHERE last_name LIKE '%GREE%';

SELECT FIRST_NAME AS prothom_nam
from employees;